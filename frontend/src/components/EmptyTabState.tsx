...
export function EmptyTabState({
	...
	return (
		<div className="flex min-h-[400px] flex-col items-center justify-center gap-6 rounded-lg border border-border border-dashed bg-muted/20 p-12">
			...
			<div className="flex items-center gap-3">
				<Button onClick={onLoadSession} type="button" variant="outline">
