...
type GenerationSessionRepositoryMock struct {
	...
	UpsertFunc                     func(projectID uint, sourceBranch, targetBranch, messagesJSON string) (*models.GenerationSession, error)
...
func (m *GenerationSessionRepositoryMock) Upsert(projectID uint, sourceBranch, targetBranch, messagesJSON string) (*models.GenerationSession, error) {
	if m.UpsertFunc != nil {
		return m.UpsertFunc(projectID, sourceBranch, targetBranch, messagesJSON)
	}
	return nil, nil
}
